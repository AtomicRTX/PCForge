...
(
    game_id           integer generated by default as identity
        primary key,
    hdd_space         double precision not null,
    min_cpu_cores     double precision not null,
    min_cpu_speed     double precision not null,
    min_cpu_threads   double precision not null,
    min_gpu_vram      double precision not null,
    min_ram           double precision not null,
    recom_cpu_cores   double precision not null,
    recom_cpu_speed   double precision not null,
    recom_cpu_threads double precision not null,
    recom_gpu_vram    double precision not null,
    recom_ram         double precision not null,
    name              varchar(255)     not null
);
...
(
    cs_id     integer          not null
        constraint fkdmg17v404xtv5s0tnllf96bsq
            references computer_setup ON DELETE CASCADE,
