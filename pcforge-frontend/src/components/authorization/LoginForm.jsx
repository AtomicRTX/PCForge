...
const LoginForm = () => {
    ...
    return (
        <main
            className='flex flex-col m-auto bg-white sm:rounded-3xl w-full md:w-2/5 lg:w-1/4 md:h-3/4 lg:h-3/4 h-screen shadow-lg p-5'>
            <Link to={-1}>
            ...
            <Form onSubmit={handleLogin} ref={form}>
                ...
                <div className="mx-5">
                    <button
                        className="bg-sky-500 text-white rounded-lg h-10 hover:bg-sky-700 focus:outline-none focus:bg-sky-900 w-full my-2">Login
                        now
                    </button>
                </div>
